...
export default function Planner() {
  return (
    <>
      <Helmet>
        <title>Planificador de Viajes Personalizado | Viajes La Corona</title>
        <meta
          name="description"
      ...
      <section className="pt-40 pb-32 min-h-screen relative flex items-center justify-center">
        <div className="text-center max-w-3xl mx-auto px-6">
          ...
          <p className="text-xl text-offwhite/70 mb-10">
            Nuestro planificador de viajes interactivo se está perfeccionando actualmente para ofrecerte
